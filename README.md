...
Pontmore is a Nostr-native protocol family for agent identity, capability discovery, escrow declaration, service schema discovery, and swap lifecycle coordination.
...
- [PIP-01-escrow-descriptor.md](./PIP-01-escrow-descriptor.md)
  - Implementation: `Required`
  - public escrow interop descriptor for discovery, compatibility, and service schema discovery
...
These define the public discovery model, escrow descriptor surface, swap event lifecycle, and dispute boundary needed for a usable Pontmore-compatible implementation.
